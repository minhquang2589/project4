...
export default {
    ...
    methods: {
        ...
        async fetchDataSlider() {
            try {
                const response = await axios.get("/api/slider/view");
                //   console.log(response.data);
                if (response.data.success == true) {
                    this.dataSlider = response.data.dataSlider;
                } else {
