<template>
    <div @mouseleave="closeNotification" class="viewCart">
        <div class="bg-white">
            <div
                class="flex justify-end bg-white text-gray-900 mx-4 mt-4 transition"
            >
                <button @click="closeViewNotification" class="togger-hidden">X</button>
            </div>
            <div class="text-center">
                <h1 class="text-xl font-bold text-gray-900">Notification</h1>
            </div>
